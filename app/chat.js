...
app.get('/', (req, res) => {
		...
		res.locals.newU = '<p id="text" class="text">No Ifriends você pode conversar com pessoas aleatórias e desconhecidas! Seja para amizade ou paquera! Fale com desconhecidos! Faça amigos!</p>'
		id++ 
		req.session.name = id
